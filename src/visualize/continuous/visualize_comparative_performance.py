...
Results are saved to visualizations/comparative_performace/
"""
...
def load_metrics(problem_name, results_dir='results/performance'):
    """
...
def load_scalability(problem_name, results_dir='results/performance'):
    """
...
def plot_performance_comparison(problems=['sphere', 'ackley', 'rastrigin'],
                                ...
                                output_dir='visualizations/performance/overview'):
    """
...
def plot_radar_chart(problem_name, results_dir='results/performance',
                    output_dir='visualizations/performance/overview'):
    """
